<footer class="footer">
       <div class="footer__column">
           <nav class="footer__nav">
               <ul class="footer__list">
                 <li class="footer__list-item"><a href="<?php echo base_url()?>home" class="footer__link">Home</a></li>
       ...
       <div class="footer__column">
           <span class="footer__copyright">© 2019 <a href="<?php echo base_url();?>">ECE TKMCE</a> Made with love in India </span>
       </div>
   </footer>
</body>
