<!-- footer arae start -->
			<footer style="background-color: #04091e;">
				<div class="container">
					<div class="row footer-bottom d-flex justify-content-between">
						<p class="col-lg-8 col-sm-12 footer-text m-0"><font color="#FFFFFF">
									Copyright &copy; 2019 <a href="http://ecetkmce.ml"> - ECETKMCE</a></font></p>
						<div class="col-lg-4 col-sm-12 footer-social">
							<a href="#"><i class="fa fa-instagram"></i></a>
							<a href="#"><i class="fa fa-facebook"></i></a>
							<a href="mailto:eceassociation.tkmce@gmail.com"><i class="fa fa-envelope"></i></a>
						</div>
					</div>
				</div>
				<br>
