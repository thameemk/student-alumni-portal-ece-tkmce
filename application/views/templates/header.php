...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title><?php echo $page_title; ?> - Department of Electronics and communication engineering TKMCE</title>
	...
	<header id="header" id="home">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6 col-sm-6 col-4 header-top-right no-padding">
						<a href="mailto:eceassociation.tkmce@gmail.com"><span class="lnr lnr-envelope"></span> <span class="text">eceassociation.tkmce@gmail.com</span></a>
					</div>
				</div>
			</div>
		</div>
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="<?php echo base_url();?>home"><img src="<?php echo base_url ()?>assets/front/img/ece_logo.png" alt="" title="" /><span class="text-white font-weight-bold px-3 ">Department of Electronics and communication</span></a>
				</div>
