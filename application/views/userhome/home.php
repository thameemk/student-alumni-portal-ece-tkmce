        ...
        <div class="col-sm-12 col-md-7 align-self-center">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">All Blog Grid</li>
            </ol>
          </nav>
        </div>
        <div class="col-md-5">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
          <div class="main-blog">
            <div class="blog-img">
              <img src="<?=base_url()?>assets/user-home/images/posts/01.jpg" class="img-fluid" alt="image">
            </div>
            <div class="blog-detail">
              ...
              <div class="blog-info">
                <a href=""><img src="<?=base_url()?>assets/user-home/images/users/01.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Glen Jax</span></a>
