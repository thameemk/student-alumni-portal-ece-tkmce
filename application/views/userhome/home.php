        ...
        <div class="col-lg-4 col-md-6 col-sm-12" id="<?=$row['title']?>">
          <div class="main-blog">
            <div class="blog-detail">
              <a href="javascript:void(0);"><h6 class="mt-1 iq-fw-8"><?=$row['title']?></h6></a>
              ...
              <div class="blog-info">
                <a href="javascript:void(0);"><img src="<?php echo base_url()?>assets/userhome/img/<?=$row['author_img']?>" class="img-fluid rounded-circle mr-3 user-img" alt="<?=$row['author_img']?>"><span class="iq-fw-8 font-c iq-font-18"><?=$row['author_first_name']?>&nbsp;<?=$row['author_last_name']?></span></a>
              </div>
            </div>
          </div>
        </div>
